...
public class DeleteProductCaseUse {
    ...
    public DeleteProductCaseUse(FindByNameProductCaseUse findByNameProductCaseUse, ProductDomainMapper productMapper, Validator validator, ProductRepository productRepository) {

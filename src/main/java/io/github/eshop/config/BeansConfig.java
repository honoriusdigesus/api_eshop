...
public class BeansConfig {
    ...
    @Bean
    public CreateOrderCaseUse createOrderCaseUse(OrderRepository orderRepository, OrderDomainMapper orderMapper) {
        return new CreateOrderCaseUse(orderRepository, orderMapper);
    }
}
